use std::{ffi::c_void, ptr, slice, str::{self, FromStr, from_utf8_unchecked}};
...
use core_services::{TCFType, UTTypeCreatePreferredIdentifierForTag, kUTTagClassMIMEType, CFStringRef};

use crate::CustomItem;

use super::{NSPasteboardTypeString, NSPasteboardTypeHTML, NSPasteboardTypePNG};
